...
?>
                    <table cellpadding="20" cellspacing="30" border="0" style="background:#ffffff url(images/page.gif);text-align:left;line-height:20px;">
                        ...
                        <tr>
                            <td>Student Name</td>
                            <td><font style="font-family:cursive;font-size:17px;" >: <?php echo $_SESSION['stdname']; ?></font></td>
                        </tr>
                        <tr>
                            <td>Test</td>
                            <td><font style="font-family:cursive;font-size:17px;" >: Sample Test</font></td>
                        </tr>
                        <tr>
                            <td>Subject</td>
                            <td><font style="font-family:cursive;font-size:17px;" >: General Knowledge</font></td>
                        </tr>
                        <tr>
                            <td>Test Duration</td>
                            <td><font style="font-family:cursive;font-size:17px;" >: 00:02:00</font></td>
                        </tr>
                        <tr>
                            <td>Max. Marks</td>
                            <td><font style="font-family:cursive;font-size:17px;" >: 2</font></td>
                        </tr>
                        <tr>
                            <td>Obtained Marks</td>
                            <td><font style="font-family:cursive;font-size:17px;" >: <?php
                    $marks = 0;
...
?></font></td>
                        ...
                        <tr>
                            <td>Percentage</td>
                            <td><font style="font-family:cursive;font-size:17px;" >: <?php echo (($marks / 2) * 100) . " %"; ?></font></td>
                        </tr>
                        <tr>
