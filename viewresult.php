              ...
              ?>
                ...
                <div class="page">
                    ...
                    <tr>
                        ...
                        <tr>
                            <td>Student Name</td>
                            <td><font style="font-family:cursive;font-size:16px;" >: <?php echo htmlspecialchars_decode($r['stdname'],ENT_QUOTES); ?></font></td>
                        </tr>
                        <tr>
                            <td>Test</td>
                            <td><font style="font-family:cursive;font-size:16px;" >: <?php echo htmlspecialchars_decode($r['testname'],ENT_QUOTES); ?></font></td>
                        </tr>
                        <tr>
                            <td>Subject</td>
                            <td><font style="font-family:cursive;font-size:16px;" >: <?php echo htmlspecialchars_decode($r['subname'],ENT_QUOTES); ?></font></td>
                        </tr>
                        <tr>
                            <td>Date and Time</td>
                            <td><font style="font-family:cursive;font-size:16px;" >: <?php echo $r['stime']; ?></font></td>
                        </tr>
                        <tr>
                            <td>Test Duration</td>
                            <td><font style="font-family:cursive;font-size:16px;" >: <?php echo $r['dur']; ?></font></td>
                        </tr>
                        <tr>
                            <td>Max. Marks</td>
                            <td><font style="font-family:cursive;font-size:16px;" >: <?php echo $r['tm']; ?></font></td>
                        </tr>
                        <tr>
                            <td>Obtained Marks</td>
                            <td><font style="font-family:cursive;font-size:16px;" >: <?php echo $r['om']; ?></font></td>
                        </tr>
                        <tr>
                            <td>Percentage</td>
                            <td><font style="font-family:cursive;font-size:16px;" >: <?php echo (($r['om']/$r['tm'])*100)." %"; ?></font></td>
                        </tr>
                        <tr>
