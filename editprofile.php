      ...
      <div class="page">
        ...
        ?></td></tr>
              ...
              <tr>
                  ...
                  <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="cname" value="<?php echo htmlspecialchars_decode($r['stdname'],ENT_QUOTES); ?>" size="16" disabled/></td>

              </tr>

                      <tr>
                  <td><font style="font-family:cursive;" >Password</font></td>
                  <td><input style="border-radius:4px;width:220px;height:20px;" type="password" name="password" value="<?php echo htmlspecialchars_decode($r['stdpass'],ENT_QUOTES); ?>" size="16" onkeyup="isalphanum(this)" /></td>
              ...
              <tr>
                  ...
                  <td><input style="border-radius:4px;width:220px;height:20px;text-style:cursive;" type="text" name="city" value="<?php echo htmlspecialchars_decode($r['city'],ENT_QUOTES); ?>" size="16" onkeyup="isalpha(this)"/></td>
              </tr>
                       <tr>
                  <td><font style="font-family:cursive;" >PIN Code</font></td>
                  <td><input type="hidden" name="student" value="<?php echo $r['stdid']; ?>"/><input style="border-radius:4px;width:220px;height:20px;" type="text" name="pin" value="<?php echo htmlspecialchars_decode($r['pincode'],ENT_QUOTES); ?>" size="16" onkeyup="isnum(this)" /></td>
              </tr>
