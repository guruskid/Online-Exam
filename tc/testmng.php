...
?>
                        ...
                        <tr>
                            ...
                            <td><textarea style="border-radius:4px;width:220px;height:60px;" name="testdesc" cols="20" rows="5" ></textarea></td>
                        ...
                        <tr>
                            ...
                            <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="duration" value="" size="16" onKeyUp="isnum(this)" /></td>
...
?>
                        ...
                        <tr>
                            <td><font style="font-family:cursive;" >Test Description</font></td>
                            <td><textarea style="border-radius:4px;width:220px;height:60px;" name="testdesc" cols="20" rows="5" ><?php echo htmlspecialchars_decode($r['testdesc'], ENT_QUOTES); ?></textarea></td>
                            <td><div class="help"><b>Describe here:</b><br/>What the test is all about?</div></td>
                        </tr>
                        <tr>
                            <td><font style="font-family:cursive;" >Total Questions</font></td>
