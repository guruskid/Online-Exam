            ...
            <form name="rsltmng" action="rsltmng.php" method="post">
                ...
                <div class="page">
                    ...
                    <table cellpadding="20" cellspacing="30" border="0" style="background:#ffffff url(../images/page.gif);text-align:left;line-height:20px;">
                        ...
                        <tr>
                            <td>Test Name</td>
                            <td><font style="font-family:cursive;font-size:17px;" >: <?php echo htmlspecialchars_decode($r['testname'],ENT_QUOTES); ?></font></td>
                        </tr>
                        <tr>
                            <td>Subject Name</td>
                            <td><font style="font-family:cursive;font-size:17px;" >: <?php echo htmlspecialchars_decode($r['subname'],ENT_QUOTES); ?></font></td>
                        </tr>
                        <tr>
                            <td>Validity</td>
                            <td><font style="font-family:cursive;font-size:17px;" >: <?php echo $r['fromdate']." To ".$r['todate']; ?></font></td>
                        </tr>
                        <tr>
                            <td>Max. Marks</td>
                            <td><font style="font-family:cursive;font-size:17px;" >: <?php echo $r['maxmarks']; ?></font></td>
                        </tr>
