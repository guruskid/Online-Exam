                ...
                <div class="page">
                        ...
                        ?>
                                <table cellpadding="20" cellspacing="20" style="text-align:left;" >
                                    <tr>
                                        <td><font style="font-family:cursive;" >Question</font></td>
                                        <td><textarea style="border-radius:4px;width:220px;height:60px;" name="question" cols="40" rows="5"  ></textarea></td>
                                    </tr>
                                    <tr>
                                        <td><font style="font-family:cursive;" >Option A</font></td>
                                        <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="optiona" value="" size="30"  /></td>
                                    </tr>
                                    <tr>
                                        <td><font style="font-family:cursive;" >Option B</font></td>
                                        <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="optionb" value="" size="30"  /></td>
                                    </tr>

                                    <tr>
                                        <td><font style="font-family:cursive;" >Option C</font></td>
                                        <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="optionc" value="" size="30"  /></td>
                                    </tr>
                                    <tr>
                                        <td><font style="font-family:cursive;" >Option D</font></td>
                                        <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="optiond" value="" size="30"  /></td>
                                    </tr>
                                    <tr>
                                        <td><font style="font-family:cursive;" >Correct Answer</font></td>
                                        <td>
                                            <select style="border-radius:4px;width:220px;height:20px;" name="correctans">
                                    ...
                                    <tr>
                                        <td><font style="font-family:cursive;" >Marks</font></td>
                                        <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="marks" value="1" size="30" onKeyUp="isnum(this)" /></td>
...
?>
                                    <table cellpadding="20" cellspacing="20" style="text-align:left;margin-left:25em;" >
                                        <tr>
                                            <td><font style="font-family:cursive;" >Question</font><input style="border-radius:4px;width:220px;height:20px;" type="hidden" name="qnid" value="<?php echo $r['qnid']; ?>" /></td>
                                            <td><textarea style="border-radius:4px;width:220px;height:60px;" name="question" cols="40" rows="5"  ><?php echo htmlspecialchars_decode($r['question'],ENT_QUOTES); ?></textarea></td>
                                        </tr>
                                        <tr>
                                            <td><font style="font-family:cursive;" >Option A</font></td>
                                            <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="optiona" value="<?php echo htmlspecialchars_decode($r['optiona'],ENT_QUOTES); ?>" size="30"  /></td>
                                        </tr>
                                        <tr>
                                            <td><font style="font-family:cursive;" >Option B</font></td>
                                            <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="optionb" value="<?php echo htmlspecialchars_decode($r['optionb'],ENT_QUOTES); ?>" size="30"  /></td>
                                        </tr>

                                        <tr>
                                            <td><font style="font-family:cursive;" >Option C</font></td>
                                            <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="optionc" value="<?php echo htmlspecialchars_decode($r['optionc'],ENT_QUOTES); ?>" size="30"  /></td>
                                        </tr>
                                        <tr>
                                            <td><font style="font-family:cursive;" >Option D</font></td>
                                            <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="optiond" value="<?php echo htmlspecialchars_decode($r['optiond'],ENT_QUOTES); ?>" size="30"  /></td>
                                        </tr>
                                        <tr>
                                            <td><font style="font-family:cursive;" >Correct Answer</font></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td><font style="font-family:cursive;" >Marks</font></td>
                                            <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="marks" value="<?php echo htmlspecialchars_decode($r['marks'],ENT_QUOTES); ?>" size="30" onKeyUp="isnum(this)" /></td>
