...
?>
                    <table cellpadding="20" cellspacing="20" style="text-align:center;margin-left:25em" >
                        <tr>
                            <td><font style="font-family:cursive;" >Subject Name</font></td>
                            <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="subname" value="" size="16" onKeyUp="isalphanum(this)" onBlur="if(this.value==''){alert('Subject Name is Empty');this.focus();this.value='';}"/></td>

                        </tr>

                        <tr>
                            <td><font style="font-family:cursive;" >Subject Description</font></td>
                            <td><textarea style="border-radius:4px;width:220px;height:60px;" name="subdesc" cols="20" rows="4" onBlur="if(this.value==''){alert('Subject Description is Empty');this.focus();this.value='';}"></textarea></td>
                        </tr>
...
?>
                    <table cellpadding="20" cellspacing="20" style="text-align:left;margin-left:25em" >
                        <tr>
                            <td><font style="font-family:cursive;" >Subject Name</font></td>
                            <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="subname" value="<?php echo htmlspecialchars_decode($r['subname'], ENT_QUOTES); ?>" size="16" onKeyUp="isalphanum(this)"/></td>

                        </tr>
                        <tr>
                            <td><font style="font-family:cursive;" >Subject Description</font></td>
                            <td><textarea style="border-radius:4px;width:220px;height:60px;" name="subdesc" cols="20" rows="4"><?php echo htmlspecialchars_decode($r['subdesc'], ENT_QUOTES); ?></textarea><input style="border-radius:4px;width:220px;height:20px;" type="hidden" name="subject" value="<?php echo $r['subid']; ?>"/></td>
                        </tr>
                    </table>
<?php
                    closedb();
