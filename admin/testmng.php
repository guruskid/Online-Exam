...
if (!isset($_SESSION['admname'])) {
    ...
    if (strtotime($fromtime) > strtotime($totime) || strtotime($totime) < time())
        ...
        $query = "update test set testname='" . htmlspecialchars($_REQUEST['testname'], ENT_QUOTES) . "',testdesc='" . htmlspecialchars($_REQUEST['testdesc'], ENT_QUOTES) . "',subid=" . htmlspecialchars($_REQUEST['subject'], ENT_QUOTES) . ",testfrom='" . $fromtime . "',testto='" . $totime . "',duration=" . $_POST['duration'] . ",totalquestions=" . htmlspecialchars($_REQUEST['totalqn'], ENT_QUOTES) . ",testcode=ENCODE('" . htmlspecialchars($_REQUEST['testcode'], ENT_QUOTES) . "','oespass') where testid=" . $_REQUEST['testid'] . ";";
    ...
    if (strcmp($_REQUEST['subject'], "<Choose the Subject>") == 0 || empty($_REQUEST['testname']) || empty($_REQUEST['testdesc']) || empty($_REQUEST['totalqn']) || empty($_REQUEST['duration']) || empty($_REQUEST['testfrom']) || empty($_REQUEST['testto']) || empty($_REQUEST['testcode'])) {
        ...
        $query = "insert into test values($newstd,'" . htmlspecialchars($_REQUEST['testname'], ENT_QUOTES) . "','" . htmlspecialchars($_REQUEST['testdesc'], ENT_QUOTES) . "',(select curDate()),(select curTime())," . htmlspecialchars($_REQUEST['subject'], ENT_QUOTES) . ",'" . $fromtime . "','" . $totime . "'," . $_POST['duration'] . "," . htmlspecialchars($_REQUEST['totalqn'], ENT_QUOTES) . ",0,ENCODE('" . htmlspecialchars($_REQUEST['testcode'], ENT_QUOTES) . "','oespass'),NULL)";
        if (!@executeQuery($query)) {
            if (mysql_errno () == 1062)
...
?>
                    <table cellpadding="20" cellspacing="20" style="text-align:left;" >
                        <tr>
                            <td><font style="font-family:cursive;" >Subject Name</font></td>
                            <td>
                                <select style="border-radius:4px;width:220px;height:20px;" name="subject">
...
?>
                        ...
                        <tr>
                            <td><font style="font-family:cursive;" >Test Name</font></td>
                            <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="testname" value="" size="16" onKeyUp="isalphanum(this)" /></td>
                            <td><div class="help"><b>Note:</b><br/>Test Name must be Unique<br/> in order to identify different<br/> tests on same subject.</div></td>
                        </tr>
                        <tr>
                            <td><font style="font-family:cursive;" >Test Description</font></td>
                            <td><textarea style="border-radius:4px;width:220px;height:40px;" name="testdesc" cols="20" rows="4" ></textarea></td>
                            <td><div class="help"><b>Describe here:</b><br/>What the test is all about?</div></td>
                        </tr>
                        <tr>
                            <td><font style="font-family:cursive;" >Total Questions</font></td>
                            <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="totalqn" value="" size="16" onKeyUp="isnum(this)" /></td>

                        </tr>
                        <tr>
                            <td><font style="font-family:cursive;" >Duration(Mins)</font></td>
                            <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="duration" value="" size="16"  /></td>

                        </tr>
                        <tr>
                            <td><font style="font-family:cursive;" >Test From </font></td>
                            <td><input style="border-radius:4px;width:220px;height:20px;" id="testfrom" type="text" name="testfrom" value="" size="16" readonly /></td>
                        </tr>
                        <tr>
                            <td><font style="font-family:cursive;" >Test To </font></td>
                            <td><input style="border-radius:4px;width:220px;height:20px;" id="testto" type="text" name="testto" value="" size="16" readonly /></td>
                        </tr>

                        <tr>
                            <td><font style="font-family:cursive;" >Test Secret Code</font></td>
                            <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="testcode" value="" size="16" onKeyUp="isalphanum(this)" /></td>
...
?>
                        ...
                        <tr>
                            <td><font style="font-family:cursive;" >Test Name</font></td>
                            <td><input style="border-radius:4px;width:220px;height:20px;" type="hidden" name="testid" value="<?php echo $r['testid']; ?>"/><input type="text" name="testname" value="<?php echo htmlspecialchars_decode($r['testname'], ENT_QUOTES); ?>" size="16" onKeyUp="isalphanum(this)" /></td>
                            <td><div class="help"><b>Note:</b><br/>Test Name must be Unique<br/> in order to identify different<br/> tests on same subject.</div></td>
                        </tr>
                        <tr>
                            <td><font style="font-family:cursive;" >Test Description</font></td>
                            <td><textarea style="border-radius:4px;width:220px;height:40px;" name="testdesc" cols="20" rows="4" ><?php echo htmlspecialchars_decode($r['testdesc'], ENT_QUOTES); ?></textarea></td>
                            <td><div class="help"><b>Describe here:</b><br/>What the test is all about?</div></td>
                        </tr>
                        <tr>
                            <td><font style="font-family:cursive;" >Total Questions</font></td>
                            <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="totalqn" value="<?php echo htmlspecialchars_decode($r['totalquestions'], ENT_QUOTES); ?>" size="16" onKeyUp="isnum(this)" /></td>

                        </tr>
                        <tr>
                            <td><font style="font-family:cursive;" >Duration(Mins)</font></td>
                            <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="duration" value="<?php echo htmlspecialchars_decode($r['duration'], ENT_QUOTES); ?>" size="16" onKeyUp="isnum(this)" /></td>

                        </tr>
                        <tr>
                            <td><font style="font-family:cursive;" >Test From </font></td>
                            <td><input style="border-radius:4px;width:220px;height:20px;" id="testfrom" type="text" name="testfrom" value="<?php echo $r['testfrom']; ?>" size="16" readonly /></td>
                        </tr>
                        <tr>
                            <td><font style="font-family:cursive;" >Test To </font></td>
                            <td><input style="border-radius:4px;width:220px;height:20px;" id="testto" type="text" name="testto" value="<?php echo $r['testto']; ?>" size="16" readonly /></td>
                        </tr>

                        <tr>
                            <td><font style="font-family:cursive;" >Test Secret Code</font></td>
                            <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="testcode" value="<?php echo htmlspecialchars_decode($r['tcode'], ENT_QUOTES); ?>" size="16" onKeyUp="isalphanum(this)" /></td>
                            <td><div class="help"><b>Note:</b><br/>Candidates must enter<br/>this code in order to <br/> take the test</div></td>
                        </tr>
