...
?>
                    <table class="tablog"cellpadding="20" cellspacing="20" style="text-align:left;margin-left:25em" >
                        <tr>
                            ...
                            <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="cname" value="" size="16" onKeyUp="isalphanum(this)"/></td>

                        </tr>

                        <tr>
                            <td><font style="font-family:cursive;" >Password</font></td>
                            <td><input style="border-radius:4px;width:220px;height:20px;" type="password" name="password" value="" size="16" onKeyUp="isalphanum(this)" /></td>

                        </tr>
                        <tr>
                            <td><font style="font-family:cursive;" >Re-type Password</font></td>
                            <td><input style="border-radius:4px;width:220px;height:20px;" type="password" name="repass" value="" size="16" onKeyUp="isalphanum(this)" /></td>

                        </tr>
                        <tr>
                            <td height="53"><font style="font-family:cursive;" >E-mail ID</font></td>
                          <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="email" value="" size="16" /></td>
                        </tr>
                        <tr>
                            <td><font style="font-family:cursive;" >Contact No</font></td>
                            <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="contactno" value="" size="16" onKeyUp="isnum(this)"/></td>
                        </tr>

                        <tr>
                            <td><font style="font-family:cursive;" >Address</font></td>
                            <td><textarea style="border-radius:4px;width:220px;height:40px;" name="address" cols="20" rows="3"></textarea></td>
                        </tr>
                        <tr>
                            <td><font style="font-family:cursive;" >City</font></td>
                            <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="city" value="" size="16" onKeyUp="isalpha(this)"/></td>
                        </tr>
                        <tr>
                            <td><font style="font-family:cursive;" >PIN Code</font></td>
                            <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="pin" value="" size="16" onKeyUp="isnum(this)" /></td>
                        </tr>
...
?>
                    <table class="tablog" cellpadding="20" cellspacing="20" style="text-align:left;margin-left:25em" >
                        <tr>
                            <td><font style="font-family:cursive;" >User Name</font></td>
                            <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="cname" value="<?php echo htmlspecialchars_decode($r['stdname'], ENT_QUOTES); ?>" size="16" onKeyUp="isalphanum(this)"/></td>

                        </tr>

                        <tr>
                            <td><font style="font-family:cursive;" >Password</font></td>
                            <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="password" value="<?php echo htmlspecialchars_decode($r['stdpass'], ENT_QUOTES); ?>" size="16" onKeyUp="isalphanum(this)" /></td>
                        ...
                        <tr>
                            <td><font style="font-family:cursive;" >Address</font></td>
                            <td><textarea style="border-radius:4px;width:220px;height:40px;" name="address" cols="20" rows="3"><?php echo htmlspecialchars_decode($r['address'], ENT_QUOTES); ?></textarea></td>
                        </tr>
                        <tr>
                            <td><font style="font-family:cursive;" >City</font></td>
                        ...
                        <tr>
                            <td><font style="font-family:cursive;" >PIN Code</font></td>
                            <td><input style="border-radius:4px;width:220px;height:20px;" type="hidden" name="student" value="<?php echo htmlspecialchars_decode($r['stdid'], ENT_QUOTES); ?>"/><input style="border-radius:4px;width:220px;height:20px;" type="text" name="pin" value="<?php echo $r['pincode']; ?>" size="16" onKeyUp="isnum(this)" /></td>
                        </tr>
