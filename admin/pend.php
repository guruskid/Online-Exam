...
?>
                    <table cellpadding="20" cellspacing="20" style="text-align:left;margin-left:15em" >
                        ...
                        <tr>
                            <td><font style="font-family:cursive;" >PIN Code</font></td>
                            <td><input style="border-radius:4px;width:220px;height:20px;" type="hidden" name="student" value="<?php echo htmlspecialchars_decode($r['stdid'], ENT_QUOTES); ?>"/><input type="text" name="pin" value="<?php echo $r['pincode']; ?>" size="16" onKeyUp="isnum(this)" /></td>
                        </tr>
