...
?>
                    <table class="tablog"cellpadding="20" cellspacing="20" style="text-align:left;margin-left:25em" >
                        ...
                        <tr>
                            ...
                            <td><textarea style="border-radius:4px;width:220px;height:60px;" name="address" cols="20" rows="5"></textarea></td>
                        </tr>
                        <tr>
...
?>
                            <table class="tablog"cellpadding="20" cellspacing="20" style="text-align:left;margin-left:25em" >
                                <tr>
                                    <td><font style="font-family:cursive;" >TC Name</font></td>
                                    <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="cname" value="<?php echo htmlspecialchars_decode($r['tcname'],ENT_QUOTES); ?>" size="16" onKeyUp="isalphanum(this)"/></td>

                                </tr>

                                <tr>
                                    <td><font style="font-family:cursive;" >Password</font></td>
                                    <td><input style="border-radius:4px;width:220px;height:20px;" type="text" name="password" value="<?php echo htmlspecialchars_decode($r['tcpass'],ENT_QUOTES); ?>" size="16" onKeyUp="isalphanum(this)" /></td>
                                ...
                                <tr>
                                    <td><font style="font-family:cursive;" >Address</font></td>
                                    <td><textarea style="border-radius:4px;width:220px;height:60px;" name="address" cols="20" rows="5"><?php echo htmlspecialchars_decode($r['address'],ENT_QUOTES); ?></textarea></td>
                                </tr>
                                <tr>
                                    <td><font style="font-family:cursive;" >City</font></td>
                                ...
                                <tr>
                                    <td><font style="font-family:cursive;" >PIN Code</font></td>
                                    <td><input style="border-radius:4px;width:220px;height:20px;" type="hidden" name="tc" value="<?php echo htmlspecialchars_decode($r['tcid'],ENT_QUOTES); ?>"/><input  style="border-radius:4px;width:220px;height:20px;" type="text" name="pin" value="<?php echo htmlspecialchars_decode($r['pincode'],ENT_QUOTES); ?>" size="16" onKeyUp="isnum(this)" /></td>
                                </tr>
